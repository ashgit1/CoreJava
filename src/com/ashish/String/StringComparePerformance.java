...
public class StringComparePerformance {
	...
	public static void main(String[] args) {
		...
		System.out.println("Time taken for creation of 5000000 String literals : " + (endTime - startTime) + " milli seconds");
		...
		System.out.println("Time taken for creation of 5000000 String objects : " + (endTime1 - startTime1) + " milli seconds");
